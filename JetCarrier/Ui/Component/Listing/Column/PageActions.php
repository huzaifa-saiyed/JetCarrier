...
namespace Kitchen365\JetCarrier\Ui\Component\Listing\Column;
...
{
    /** Url path */
    const CMS_URL_PATH_EDIT = 'jetcarrier/form/jetcarrierform';
    const CMS_URL_PATH_DELETE = 'jetcarrier/index/delete';
